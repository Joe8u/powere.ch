...
export function KPIs({ mfrr, lastp, lpSel, agg }: { mfrr: MfrrPoint[]; lastp?: LastprofileRow[] | null; lpSel?: string[]; agg: Agg }) {
  ...
  return (
    <section>
      <div style={{ border: '1px solid var(--sl-color-hairline)', borderRadius: 12, padding: 16 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: 12, alignItems: 'stretch', gridAutoRows: '1fr' }}>
