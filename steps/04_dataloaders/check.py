...
from steps.powere_lib.dataloaders.survey import load_attitudes, load_demand_response, load_demographics, load_incentives, load_nonuse, load_socioeconomics
...
print("✅ Step 4 OK — alle Dataloader-Smoke-Checks bestanden.")
